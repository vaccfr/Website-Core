              ...
              <div id="map" style="height: calc(50vh - 120px)" class="mt-2">
                ...
                @endforeach
                  ...
                  @if ($livemap['lfff'])
                    ...
                    L.polygon(lfffLatLong, {color: 'red', fillOpacity: 0.1}).addTo(map);
                  @endif
                  ...
                  @if ($livemap['lfrr'])
                    ...
                    L.polygon(lfrrLatLong, {color: 'red', fillOpacity: 0.1}).addTo(map);
                  @endif
                  ...
                  @if ($livemap['lfee'])
                    ...
                    L.polygon(lfeeLatLong, {color: 'red', fillOpacity: 0.1}).addTo(map);
                  @endif
                  ...
                  @if ($livemap['lfbb'])
                    ...
                    L.polygon(lfbbLatLong, {color: 'red', fillOpacity: 0.1}).addTo(map);
                  @endif
                  ...
                  @if ($livemap['lfmm'])
                    ...
                    L.polygon(lfmmLatLong, {color: 'red', fillOpacity: 0.1}).addTo(map);
                  @endif
                  </script>
              </div>
            </main>
